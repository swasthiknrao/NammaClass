            ...
            child: Container(
              ...
              child: TabBar(
                ...
                tabs: const [
                  ...
                  Tab(icon: Icon(Icons.badge_rounded, size: 22), text: 'Staff'),
                ],
              ),
            ),
          ),
      ...
      body: TabBarView(
        ...
        children: [
          _StudentsTab(
            ...
            onToggleFilters: () =>
                setState(() => _showStudentFilters = !_showStudentFilters),
            onClassSectionChanged: (v) =>
                setState(() => _selectedClassSection = v),
            onFeeStatusChanged: (v) => setState(() => _selectedFeeStatus = v),
          ...
          _StaffTab(
            ...
            onStatusChanged: (v) => setState(() => _selectedStaffStatus = v),
